...
// import 'package:meet_a_doc/views/patients_view/nav/recent_chats.dart';
...
//           padding: const EdgeInsets.all(16),
//           decoration: BoxDecoration(
//             color: const Color.fromARGB(255, 239, 255, 221),
//             borderRadius: BorderRadius.circular(16),
//           ),
//           child: const Text(
...
class _PatientHomePageState extends State<PatientHomePage> {
  ...
  void _getUser() async {
    _user = await FirestoreService.getUserData(
